          ...
          <View style={styles.exploreSection}>
            <View style={styles.exploreSectionText}>
              ...
              <Button
                ...
                icon={<Ionicons name="arrow-forward" size={16} color="#FFFFFF" style={styles.buttonIcon} />}
                buttonStyle={styles.viewCountriesButton}
                titleStyle={styles.viewCountriesButtonText}
                onPress={() => {/* Navigate to countries list */}}
              />
            </View>
            <View style={styles.flagsContainer}>
              {['fr', 'de', 'es', 'it', 'nl', 'se'].map((code) => (
                <Image
                  key={code}
