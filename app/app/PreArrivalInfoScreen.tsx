    ...
    try {
      ...
      if (data) {
        const preArrivalData: PreArrivalInfo[] = [
          ...
          { id: 9, title: "Climate", content: data.climate || "N/A", icon: "thermometer" },
          ...
          { id: 27, title: "LGBT+ Rights", content: data.lgbt_rights || "N/A", icon: "rainbow" },
        ...
        setPreArrivalInfo(preArrivalData.filter(item => item.content !== "N/A"));
      }
      setLoading(false);
    } catch (error: any) {
